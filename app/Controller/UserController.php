...
use Bramasta\Belajar\PHP\MVC\Service\UserService;
...
class UserController
{
    ...
    public function postLogin()
    {
        ...
        try {
            $reponse = $this->userService->login($request);
            $this->sessionService->create($reponse->user->id);
            View::redirect('/');
        } catch (ValidationException $exception) {
            View::render('User/login', [
                'title' => 'User',
    ...
    public function postUpdatePassword()
    {
        ...
        $request->id = $user->id;
        $request->oldPassowrd = $_POST['oldPassword'];
